...
export function toVisualControlFrame(
  ...
  return {
    ...
    faceConfidence: clamp01(perception.faceConfidence),
    faceCenterX: clamp01(perception.faceCenterX),
    faceCenterY: clamp01(perception.faceCenterY),
    faceScale: clampRange(perception.faceScale, 0, 1, 0),
    headYaw: clampSigned(perception.yaw),
    headPitch: clampSigned(perception.pitch),
    headRoll: clampSigned(perception.roll),
